...
const listaInicialDeCandidatos: Candidato[] = [
  { id: 1, nombre: "Daniel Noboa", votos: 0, imagen: noboaImg },
  { id: 2, nombre: "Dinald Trump", votos: 0, imagen: trumpImg },
  { id: 3, nombre: "Vladimir Putin", votos: 0, imagen: putinImg },
];

// logica
export const useVotacion = () => {
  // Estado que contiene la lista actualizada de candidatos y sus votos
  const [listaDeCandidatos, actualizarListaDeCandidatos] = useState<
    Candidato[]
  >(listaInicialDeCandidatos);

  // Estado que controla si el usuario voto
  const [usuarioYaHaVotado, actualizarEstadoDeVotacion] =
